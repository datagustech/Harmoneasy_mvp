...
def main():
    ...
    st.markdown(
        "<div style='display: flex; justify-content: center;'><img src='https://github.com/datagustech/Harmoneasy_mvp/blob/main/Harmoneasy%20logo.png' style='width: 350px;'></div>",
